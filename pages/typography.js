...
export default function Typography() {
  ...
  <!-- ... -->
            ...
            <p>What follows from here is just a bunch of absolute nonsense Ive written to dogfood the plugin itself. It includes every sensible typographic element I could think of, like <strong>bold text</strong>, unordered lists, ordered lists, code blocks, block quotes, <em>and even italics</em>.</p>
            ...
            <blockquote><p>Typography is pretty important if you dont want your stuff to look like trash. Make it good then it wont be bad.</p></blockquote>
            <p>Its probably important that images look okay here by default as well:</p>
            <figure>
              <Image width={700} height={400} src="https://images.unsplash.com/photo-1556740758-90de374c12ad?&w=720&h=480&q=80" alt="images" unoptimized />
            ...
            <p>I think most people are going to use <a href="https://highlightjs.org/">highlight.js</a> or <a href="https://prismjs.com/">Prism</a> or something if they want to style their code blocks but it wouldnt hurt to make them look <em>okay</em> out of the box, even with no syntax highlighting.</p>
            <p>Heres what a default <code>tailwind.config.js</code> file looks like at the time of writing:</p>
            <p>Hopefully that looks good enough to you.</p>
            <h3>What about nested lists?</h3>
            <p>Nested lists basically always look bad which is why editors like Medium dont even let you do it, but I guess since some of you goofballs are going to do it we have to carry the burden of at least making it work.</p>
            <ol>
              <li>
              ...
              <li>
                <strong>Since we need to have more items, heres another one.</strong>
                <ul>
                  <li>Im not sure if well bother styling more than two levels deep.</li>
                  <li>Two is already too much, three is guaranteed to be a bad idea.</li>
                  <li>If you nest four levels deep you belong in prison.</li>
                </ul>
              </li>
              <li>
                <strong>Two items isnt really a list, three is good though.</strong>
                <ul>
                  <li>Again please dont nest lists if you want people to actually read your content.</li>
                  <li>Nobody wants to look at this.</li>
                  <li>Im upset that we even have to bother styling this.</li>
                </ul>
              </li>
            </ol>
            <p>The most annoying thing about lists in Markdown is that <code>&lt;li&gt;</code> elements arent given a child <code>&lt;p&gt;</code> tag unless there are multiple paragraphs in the list item. That means I have to worry about styling that annoying situation too.</p>
            <ul>
              <li>
                <p><strong>For example, heres another nested list.</strong></p>
              ...
              <li>
                ...
                <ul>
                  <li>
                    <p>As you can see here, because Ive added a second line, this list item now has a <code>&lt;p&gt;</code> tag.</p>
                    <p>This is the second line Im talking about by the way.</p>
                  </li>
                  <li><p>Finally heres another list item so its more like a list.</p></li>
                </ul>
              </li>
